...
public class Scroll  implements Interaction {
    ...
    public Scroll(String swipeType) {
    ...
    public static Scroll scrollUp() {
        return new Scroll(SCROLL_UP);
    }

    public static Scroll left() {
        return new Scroll(SWIPE_LEFT);
    }

    public static Scroll scrollDown() {
        return new Scroll(SCROLL_DOWN);
    }

    public Scroll intoElement(Target target) {
        this.target = target;
        return this;
    }
